...
public class Evaluate {
  ...
  private void processPlusPlus() throws Exception {
    ...
    if (param1 instanceof String) {
      ...
      throw new Exception("You must define the variable name for make a plus plus.");
    }
  }
  ...
  private void processPlusAssign() throws Exception {
    ...
    if (param1 instanceof String) {
      ...
      throw new Exception("You must define the variable name for make a plus assign.");
    }
  }
  ...
  private void processMinusMinus() throws Exception {
    ...
    if (param1 instanceof String) {
      ...
      throw new Exception("You must define the variable name for make a minus minus.");
    }
  }
  ...
  private void processMinusAssign() throws Exception {
    ...
    if (param1 instanceof String) {
      ...
      throw new Exception("You must define the variable name for make a minus assign.");
    }
  }
  ...
  private void processMultiplySelf() throws Exception {
    ...
    if (param1 instanceof String) {
      ...
      throw new Exception("You must define the variable name for make a multiply self.");
    }
  }
  ...
  private void processMultiplyAssign() throws Exception {
    ...
    Object param2 = stack.pollFirst();
    if (param1 instanceof String) {
      variables.set((String) param1, makeMultiply(variables.get((String) param1),
          param2));
    } else {
      throw new Exception(
  ...
  private void processDivideAssign() throws Exception {
    ...
    if (param1 instanceof String) {
      ...
      throw new Exception("You must define the variable name for make a divide assign.");
    }
  }
  ...
  private void processRestAssign() throws Exception {
    ...
    if (param1 instanceof String) {
      ...
      throw new Exception("You must define the variable name for make a rest assign.");
    }
  }
  ...
  private Object checkTernary(Object param1, Object param2, Object param3)
    ...
    if (param1 instanceof Boolean) {
      ...
      throw new Exception("You must pass a Boolean as first parameter of a ternary.");
    }
  }
    ...
    if (param1 instanceof String || param2 instanceof String) {
      ...
      if (param1 instanceof Number) {
        if (param2 instanceof Number) {
          ...
          throw new Exception("Could not make plus because parameter 2 isn't a number.");
        }
      } else {
        throw new Exception("Could not make plus because parameter 1 isn't a number.");
      }
    }
  }
  ...
  private Object makeMinus(Object param1, Object param2) throws Exception {
    if (param1 instanceof Number) {
      if (param2 instanceof Number) {
        ...
        throw new Exception("Could not make minus because parameter 2 isn't a number.");
      }
    } else {
      throw new Exception("Could not make minus because parameter 1 isn't a number.");
    }
  }
  ...
  private Object makeMultiply(Object param1, Object param2) throws Exception {
    if (param1 instanceof Number) {
      ...
      throw new Exception("Could not make multiply because parameter 1 isn't a number.");
    }
  }
  ...
  private Object makeDivide(Object param1, Object param2) throws Exception {
    if (param1 instanceof Number) {
      if (param2 instanceof Number) {
        ...
        throw new Exception("Could not make divide because parameter 2 isn't a number.");
      }
    } else {
      throw new Exception("Could not make divide because parameter 1 isn't a number.");
    }
  }
  ...
  private Object makeRest(Object param1, Object param2) throws Exception {
    if (param1 instanceof Number) {
      if (param2 instanceof Number) {
        ...
        throw new Exception("Could not make rest because parameter 2 isn't a number.");
      }
    } else {
      throw new Exception("Could not make rest because parameter 1 isn't a number.");
    }
  }
